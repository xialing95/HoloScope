...
// --- Initial Call and Periodic Updates of sensors---
...
// const sensorLoggingForm = document.getElementById('logging-form');
// // --- Event Listener for Form Submission (Start Log) ---
// if (sensorLoggingForm)
// document.addEventListener('submit', function(event) {
//     const form = event.target; // Get the form element that triggered the event
...
//         .catch(error => {
//             console.error('Error:', error);
//             statusMessage.innerText = `<p style="color:red;">Error updating content.</p>`;
//             logOutput.innerHTML = `<p>Sensor Message:</p><pre>${error}</pre>`
//         });
//     }
// });


// // --- Event Listener for I2C Reset Button ---
// // Get a reference to the form and the status element (assuming 'statusMessage' exists elsewhere)
// const resetForm = document.getElementById('i2c-reset-form');
// // const statusMessage = document.getElementById('status-message'); // You need to define this too

// // ---  Event Listener for I2C Reset Form Submission ---
// if (resetForm) {
//     resetForm.addEventListener('submit', async function(event) {
//         // 1. STOP the default form submission (prevents page reload)
//         event.preventDefault(); 
        
//         // Ensure statusMessage is available before trying to use it
//         if (typeof statusMessage === 'undefined') {
//             console.error('statusMessage element is not defined!');
//             return; 
//         }
...
//         try {
//             // The fetch URL is already specified in the form's 'action' attribute, 
//             // but explicitly setting it here is fine.
...
//                 // Re-start data updates after a successful reset (assuming updateSensorData is defined)
//                 if (typeof updateSensorData === 'function') {
//                     updateSensorData(); 
//                 }
//             } else {
//                 // Handle non-success response from the server JSON
//                 statusMessage.innerText = result.message || 'I2C reset failed.';
//                 statusMessage.style.color = 'red';
//             }
//         } catch (error) {
//             // Catches network errors, JSON parsing errors, and the custom HTTP error
//             statusMessage.innerText = 'Network or server error during reset.';
//             statusMessage.style.color = 'red';
